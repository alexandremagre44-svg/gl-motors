      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="relative h-96 md:h-[500px] bg-gray-200 rounded-lg overflow-hidden mb-6">
              ...
              <div className="absolute top-4 right-4 flex flex-col gap-2">
                ...
                {vehicle.statut === 'reserve' && (
                  <div className="bg-orange-600 text-white px-6 py-3 rounded-lg font-bold text-lg shadow-lg">
                    RÉSERVÉ
                  </div>
                )}
                {isNew && vehicle.statut === 'disponible' && (
                  <div className="bg-green-600 text-white px-6 py-3 rounded-lg font-bold text-lg shadow-lg">
                    NOUVEAU
                  </div>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-lg font-semibold text-gray-900">{vehicle.annee}</div>
                  </div>
                </div>
                <div className="flex items-start">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-lg font-semibold text-gray-900 capitalize">{vehicle.carburant}</div>
                  </div>
                </div>
                <div className="flex items-start">
                  <span className="text-3xl mr-4">⚙️</span>
                  <div>
                    ...
                    <div className="text-lg font-semibold text-gray-900 capitalize">{vehicle.boite}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-900 text-white rounded-lg shadow-lg p-8 sticky top-8">
              <h2 className="text-2xl font-bold mb-6">Intéressé par ce véhicule ?</h2>
              ...
              <div className="space-y-4">
                <a
                  ...
                  className="block w-full bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-6 rounded-lg text-center transition-colors"
                >
                  📞 Appeler le garage
                </a>
                <Link
              ...
              <div className="mt-8 pt-8 border-t border-gray-700">
                <h3 className="font-bold mb-4">Nos garanties</h3>
